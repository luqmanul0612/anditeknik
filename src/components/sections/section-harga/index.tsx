...
const packages = [
  ...
  },
  {
    ...
    features: [
      "Cuci evaporator",
      "Cuci kondensor",
      "Pembersihan drain pan",
      "Disinfektan anti jamur",
      "Garansi kebersihan 30 hari",
    ],
    popular: true,
  },
  {
...
const SectionHarga = () => {
  const openWhatsapp = () => {
    window.open(
      "https://wa.me/6281234567890?text=Halo%20Andi%20Teknik%2C%20saya%20ingin%20tanya%20tentang%20harga",
      "_blank",
    );
  };
  ...
  return (
    <div className={cn.main} id="harga">
      ...
      >
        <motion.p className={cn.subtitle} variants={fadeInUp}>HARGA TRANSPARAN</motion.p>
        <motion.h2 className={cn.title} variants={fadeInUp}>Paket Layanan</motion.h2>
        <motion.div className={cn.line} variants={fadeInUp} />
        <motion.p className={cn.desc} variants={fadeInUp}>
          Harga yang jelas dan transparan tanpa biaya tersembunyi. Dapatkan
          estimasi harga sebelum pekerjaan dimulai.
        </motion.p>
      </motion.div>
