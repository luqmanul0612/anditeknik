...
const SectionKontak = () => {
  const openWhatsapp = () => {
    window.open(
      "https://wa.me/6281234567890?text=Halo%20Andi%20Teknik%2C%20saya%20ingin%20memesan%20layanan%20AC",
      "_blank",
    );
  };
    ...
    <div className={cn.main} id="kontak">
      <div className={cn.inner}>
        ...
        >
          ...
          <p className={cn.desc}>
            Jangan biarkan AC bermasalah mengganggu kenyamanan Anda. Hubungi
            kami sekarang dan teknisi berpengalaman kami siap membantu.
          </p>
          <motion.div
            className={cn.infos}
        ...
        >
          ...
          >
            ...
            <p className={cn.ctaDesc}>
              Cara tercepat untuk menghubungi kami. Tim kami siap merespons
              pertanyaan dan pemesanan Anda melalui WhatsApp 7 hari seminggu.
            </p>
            <motion.button
              className={cn.waButton}
